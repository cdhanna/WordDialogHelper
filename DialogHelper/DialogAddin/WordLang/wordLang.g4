...
text
	: (WHITESPACE? (NAME|INTEGER|DOT|WHITESPACE|TO|SET|COMMA|TRUE|FALSE|QUOTE|MODIFY|BY) WHITESPACE?)+
	;
multilineText
	: (freeText | templatedText)*
	;
freeText
	: (WHITESPACE | NAME | NEWLINE | TO | SET | BY | MODIFY |COMMA | EQUALTO | NEGATION | FALSE | TRUE | DOT | POUND | LESSTHAN | GREATERTHAN | DIVIDE | QUOTE | DBLQUOTE)+
	;
